...
traslations = ["Translations_txt/1551_01_19_Richard_Le_Fevre_ES.txt"] #List of translated texts in Spanish
reference = ["output/VF/1551_01_19_Richard_Le_Fevre.xml"] #List of references in French already encoded in TEI
