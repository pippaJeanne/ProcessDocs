...
persdata = {}
with open("data_json/persIndex.json", "r") as indexData: # data_json/persIndex_es.json for Spanish | data_json/persIndex.json for French
  persdata = json.load(indexData)
perfile = {}
with open("data_json/wikiIds.json", "r") as data: # data_json/wikiIds_es.json for Spanish | data_json/wikiIds.json for French
...
with open("data_json/persons.json", "w") as outfile:  # persons_es.json for the Spanish version | persons.json for the French version
