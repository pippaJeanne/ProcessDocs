...
files =[]
dir = "output/VF/xml" # directory of the files to be processed
...
with open("data_json/wikiIds.json", "w") as outfile: # add '_es' at the end of the file name for the Spanish version
